...
void MainWindow::make_actions() {
  ...
  m_refActionGroup->add_action(
      "load", sigc::mem_fun(*this, &MainWindow::on_menu_load_rsc));
  m_refActionGroup->add_action(
      "unload", sigc::mem_fun(*this, &MainWindow::on_menu_unload_rsc));
  m_refActionGroup->add_action(
      "clean", sigc::mem_fun(*this, &MainWindow::on_menu_clean_rsc));
